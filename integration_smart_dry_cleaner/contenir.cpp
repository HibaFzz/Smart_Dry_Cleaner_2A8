...
Contenir::Contenir()
{
    ...
    bool Contenir::ajouter()
    {
        ...
        query.prepare("INSERT INTO CONTENIR (PRIX, QUANTITE,FK_AR,FK_COM)VALUES (:PRIX,:QUANTITE, :FK_AR, :FK_COM)");
              ...
              QSqlQuery qry;
                      ...
                      qry.prepare("insert into HISTORIQUE (ACTIVITE_H,DATE_H) values ('Passer Commande',:dateTime)");
    ...
    bool Contenir::supprimer(int FK_COM)
    {
              ...
              QSqlQuery qry;
                      ...
                      qry.prepare("insert into HISTORIQUE (ACTIVITE_H,DATE_H) values ('Supprimer une commande deja passée',:dateTime)");
                      qry.bindValue(":dateTime",dateTime);
    ...
    QSqlQueryModel* Contenir::combo_comboAr()
     {
         ...
         QSqlQueryModel* model=new QSqlQueryModel();
         model->setQuery("select REF from ARTICL ");
         return model;
     }
    ...
    QSqlQueryModel* Contenir::statistiques(){
        QSqlQueryModel* model=new QSqlQueryModel();
        model->setQuery("SELECT count(*),FK_AR FROM CONTENIR group by FK_AR ");
