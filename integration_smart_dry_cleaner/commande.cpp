...
#include <QTextStream>
    {
        ...
        query.prepare("INSERT INTO COMMANDE (ID_COM, DATE_RECEP,DATE_LIVR,FK_CLIENT,FK_EMPLOYE)VALUES (:ID_COM,:DATE_RECEP, :DATE_LIVR, :FK_CLIENT,:FK_EMPLOYE)");
              ...
              QSqlQuery qry;
                      ...
                      qry.prepare("insert into HISTORIQUE (ACTIVITE_H,DATE_H) values ('Ajout Commande',:dateTime)");
    ...
    bool Commande::supprimer(int ID_COM)
    {
              ...
              QSqlQuery qry;
                      ...
                      qry.prepare("insert into HISTORIQUE (ACTIVITE_H,DATE_H) values ('Supprimer Commande',:dateTime)");
                      qry.bindValue(":dateTime",dateTime);
   ...
   QSqlQueryModel* Commande::combo_comboCom()
    ...
    QSqlQueryModel* Commande::statistiques1(){
        ...
        return model;}
    bool Commande::rechercher_arduino(QByteArray data)

{
        QSqlQueryModel *model=new QSqlQueryModel();
        QSqlQuery query;
        //QString res = QString::number(data);
        query.prepare("SELECT * FROM commande WHERE id_com ="+data);
